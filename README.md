This is a simple web-page that allows users to register student information through an HTML form. The project is designed to be self-configuring, meaning the PHP script handles the creation of the database and tables automatically upon the first submission.
